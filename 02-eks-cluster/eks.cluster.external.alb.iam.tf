resource "aws_iam_policy" "aws_lb_controller_policy" {
  ...
  description = "AWS Load Balancer Controller IAM Role Policy"
...
resource "aws_iam_role_policy_attachment" "load_balancer_controller_AWSLoadBalancerControllerIAMRolePolicy" {
